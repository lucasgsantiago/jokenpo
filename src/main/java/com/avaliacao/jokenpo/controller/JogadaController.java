...
public class JogadaController {
    ...
    public ResponseEntity lancarJogadaPapel(@PathVariable("jogadorId") String jogadorId) throws BusinessException {
        service.lancarJogadaPapel(jogadorId);
        return ResponseEntity.ok().build();
    }

    @PostMapping("/pedra/jogador/{jogadorId}")
    public ResponseEntity lancarJogadaPedra(@PathVariable("jogadorId") String jogadorId) throws BusinessException {
        service.lancarJogadaPedra(jogadorId);
        return ResponseEntity.ok().build();
    }

    @PostMapping("/tesoura/jogador/{jogadorId}")
    public ResponseEntity lancarJogadaTesoura(@PathVariable("jogadorId") String jogadorId) throws BusinessException {
        service.lancarJogadaTesoura(jogadorId);
        return ResponseEntity.ok().build();
    }

    @PostMapping("/spock/jogador/{jogadorId}")
    public ResponseEntity lancarJogadaSpock(@PathVariable("jogadorId") String jogadorId) throws BusinessException {
        service.lancarJogadaSpock(jogadorId);
        return ResponseEntity.ok().build();
    }
    
    @PostMapping("/lagarto/jogador/{jogadorId}")
    public ResponseEntity lancarJogadaLagarto(@PathVariable("jogadorId") String jogadorId) throws BusinessException {
